...
--
-- Servidor: localhost
-- Tiempo de generación: 24-12-2013 a las 12:01:55
...
--
-- RELACIONES PARA LA TABLA `arbitro`:
--   `nombreusuario`
--       `usuario` -> `nombre`
--
...
--
-- RELACIONES PARA LA TABLA `arbitrostemporada`:
--   `numtemporada`
...
--
-- RELACIONES PARA LA TABLA `convocado`:
--   `codjug`
--       `jugador` -> `codjug`
--
...
--
-- RELACIONES PARA LA TABLA `equipostemporada`:
--   `numtemporada`
--       `temporada` -> `numtemporada`
--   `nombreeq`
--       `equipo` -> `nombre`
...
--
-- RELACIONES PARA LA TABLA `estadisticasjugador`:
--   `numtemporada`
--       `temporada` -> `numtemporada`
--   `codjug`
--       `jugador` -> `codjug`
...
--
-- RELACIONES PARA LA TABLA `goles`:
--   `codjug`
--       `jugador` -> `codjug`
--
...
--
-- RELACIONES PARA LA TABLA `historialjugador`:
--   `codjug`
--       `jugador` -> `codjug`
--   `nombreeq`
--       `equipo` -> `nombre`
...
--
-- RELACIONES PARA LA TABLA `sustituciones`:
--   `codjugsale`
--       `jugador` -> `codjug`
--   `codjugentra`
--       `jugador` -> `codjug`
...
--
-- RELACIONES PARA LA TABLA `tarjetas`:
--   `codjug`
--       `jugador` -> `codjug`
--
...
--
-- RELACIONES PARA LA TABLA `titular`:
--   `codjug`
--       `jugador` -> `codjug`
--
